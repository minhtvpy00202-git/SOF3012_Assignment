...
public class ChatbotServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        // 5. Nếu GPT không trả lời → dùng rule-based
        if (!fromOpenAI) {
    ...
    private String callOpenAI(HttpServletRequest req, String message, String apiKey) throws Exception {
        ...
        String body = "{"
                ...
                + "\"input\":["
                + " {\"role\":\"system\",\"content\":\""
                + "Bạn là trợ lý hỗ trợ người dùng cho website OE Online Entertainment – một website chia sẻ video. "
                + "Website có các chức năng theo vai trò như sau: "
                + "Người dùng chưa đăng nhập có thể xem video, đăng ký tài khoản và xem bình luận, "
                + "nhưng không thể like, share hoặc bình luận. "
                + "Người dùng đã đăng nhập có thể xem, like, share video, "
                + "xem, bình luận và trả lời bình luận, "
                + "xem danh sách video đã like, "
                + "xem và chỉnh sửa hồ sơ cá nhân, đổi mật khẩu. "
                + "Admin có toàn bộ quyền của người dùng đã đăng nhập, "
                + "đồng thời có thể quản lý người dùng, quản lý video "
                + "và xem báo cáo – thống kê lượt xem, lượt like/share và truy cập. "
                + "Các tính năng chung gồm: tìm kiếm theo từ khóa, "
                + "chuyển đổi ngôn ngữ Tiếng Việt / Tiếng Anh, "
                + "và chế độ hiển thị Sáng / Tối. "
                + "QUY TẮC: Chỉ trả lời dựa trên các chức năng trên, "
                + "không suy đoán hoặc bịa thêm tính năng. "
        ...
        String text = extractFromResponsesAPI(response.body());
